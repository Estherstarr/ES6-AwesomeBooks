# ES6-AwesomeBooks
> Built a basic website that allows users to add/remove books from a list
...
Feel free to check the [issues page](https://github.com/Estherstarr/ES6-AwesomeBooks/issues).
